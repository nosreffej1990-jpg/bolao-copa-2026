...
export async function POST(request) {
  try {
    ...
    if (currentConfs.length < 104) {
      console.log(`Detectados confrontos em falta no banco. Banco tem ${currentConfs.length}/104. Inserindo os que faltam...`);
      ...
      if (missingConfs.length > 0) {
        ...
        if (insertErr) {
          console.error('Erro ao auto-inserir confrontos ausentes:', insertErr);
        } else {
